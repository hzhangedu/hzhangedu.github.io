...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    <img src="assets/img/system.png" class="teaser img-fluid z-depth-1">
    <abbr class="badge">SYSTEM</abbr>
  </div>

  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    <div class="author">Yuhan Liu, <strong>Heng Zhang</strong>, Meilin Jiang, Juanjuan Chen, Minhong Wang (2024)</div>
    ...
    <div class="periodical"><em>System</em> <a>(Q1, IF: 4.9)</a></div>
    <div class="links">
      <a href="assets/files/system_2024.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Download</a>
      <a href="https://doi.org/10.1016/j.system.2024.103478" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Website</a>
    </div>
  </div>
</div>
</li>
...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
    ...
    <div class="periodical"><em>Knowledge Management & E-Learning</em> <a>Q1, IF: 2.5)</a></div>
    <div class="links">
